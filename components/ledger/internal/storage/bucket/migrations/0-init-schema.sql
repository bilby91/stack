...
create unique index "{{.Bucket}}_transactions_ledger" on "{{.Bucket}}".transactions (ledger, id);
create index "{{.Bucket}}_transactions_date" on "{{.Bucket}}".transactions (timestamp);
create index "{{.Bucket}}_transactions_metadata_index" on "{{.Bucket}}".transactions using gin (metadata jsonb_path_ops);
create index "{{.Bucket}}_transactions_sources" on "{{.Bucket}}".transactions using gin (sources jsonb_path_ops);
create index "{{.Bucket}}_transactions_destinations" on "{{.Bucket}}".transactions using gin (destinations jsonb_path_ops);
create index "{{.Bucket}}_transactions_sources_arrays" on "{{.Bucket}}".transactions using gin (sources_arrays jsonb_path_ops);
create index "{{.Bucket}}_transactions_destinations_arrays" on "{{.Bucket}}".transactions using gin (destinations_arrays jsonb_path_ops);
...
create index "{{.Bucket}}_transactions_metadata_metadata" on "{{.Bucket}}".transactions_metadata using gin (metadata jsonb_path_ops);
create unique index "{{.Bucket}}_transactions_metadata_ledger" on "{{.Bucket}}".transactions_metadata (ledger, transactions_seq, revision);
create index "{{.Bucket}}_transactions_metadata_revisions" on "{{.Bucket}}".transactions_metadata(transactions_seq asc, revision desc) include (metadata, date);
...
create unique index "{{.Bucket}}_accounts_ledger" on "{{.Bucket}}".accounts (ledger, address) include (seq);
create index "{{.Bucket}}_accounts_address_array" on "{{.Bucket}}".accounts using gin (address_array jsonb_ops);
create index "{{.Bucket}}_accounts_address_array_length" on "{{.Bucket}}".accounts (jsonb_array_length(address_array));
...
create unique index "{{.Bucket}}_accounts_metadata_ledger" on "{{.Bucket}}".accounts_metadata (ledger, accounts_seq, revision);
create index "{{.Bucket}}_accounts_metadata_metadata" on "{{.Bucket}}".accounts_metadata using gin (metadata jsonb_path_ops);
create index "{{.Bucket}}_accounts_metadata_revisions" on "{{.Bucket}}".accounts_metadata(accounts_seq asc, revision desc) include (metadata, date);
...
create index "{{.Bucket}}_moves_ledger" on "{{.Bucket}}".moves (ledger);
create index "{{.Bucket}}_moves_range_dates" on "{{.Bucket}}".moves (account_address, asset, effective_date);
create index "{{.Bucket}}_moves_account_address" on "{{.Bucket}}".moves (account_address);
create index "{{.Bucket}}_moves_account_address_array" on "{{.Bucket}}".moves using gin (account_address_array jsonb_ops);
create index "{{.Bucket}}_moves_account_address_array_length" on "{{.Bucket}}".moves (jsonb_array_length(account_address_array));
create index "{{.Bucket}}_moves_date" on "{{.Bucket}}".moves (effective_date);
create index "{{.Bucket}}_moves_asset" on "{{.Bucket}}".moves (asset);
create index "{{.Bucket}}_moves_post_commit_volumes" on "{{.Bucket}}".moves (accounts_seq, asset, seq);
create index "{{.Bucket}}_moves_effective_post_commit_volumes" on "{{.Bucket}}".moves (accounts_seq, asset, effective_date desc);
...
create unique index "{{.Bucket}}_logs_ledger" on "{{.Bucket}}".logs (ledger, id);
