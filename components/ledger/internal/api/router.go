...
func NewRouter(
	...
	v2Router := v2.NewRouter(backend, healthController, globalMetricsRegistry, authenticator, debug)
	...
	mux.Handle("/*", v1.NewRouter(backend, healthController, globalMetricsRegistry, authenticator, debug))
