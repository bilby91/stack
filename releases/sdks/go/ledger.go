...
func (s *Ledger) V2ExportLogs(ctx context.Context, request operations.V2ExportLogsRequest, opts ...operations.Option) (*operations.V2ExportLogsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Ledger) V2ImportLogs(ctx context.Context, request operations.V2ImportLogsRequest, opts ...operations.Option) (*operations.V2ImportLogsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
